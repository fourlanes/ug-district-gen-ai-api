...
async function loadCSVData(district, category) {
  ...
  try {
    const fileName = category === "health" ? "health_facilities.csv" : "education_facilities.csv";
...
// .wrangler/tmp/bundle-fZIpqD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-fZIpqD/middleware-loader.entry.ts
